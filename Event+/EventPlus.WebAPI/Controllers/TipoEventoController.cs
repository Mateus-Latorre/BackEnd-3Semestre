...
public class TipoEventoController : ControllerBase
{
    ...
    /// </summary>
    /// <returns>Statu code 200 e a lista de tipos de evento</returns>
    ...
    /// <summary>
    /// Endpoint da API que faz chamada para o método de buscar um tipo de evento específico
    /// </summary>
    ...
    /// <summary>
    /// endpoint da API que faz chamada para o método de cadastrar um tipo de evento
    /// </summary>
    ...
    /// </summary>
    /// <param name="id">Id do tipo do evento a ser exluído</param>
